...
namespace Webárúház_Nagy_Project.DTOs
{
    ...
    public record TermekEgyoldalAdatokWithHozzaszolasok(int TermekId,int Ar,string TermekLeiras,int Menyiseg,int KategoriaId,string Keputvonal,List<HozzaszolasAdatok> Hozzaszolasok);
}
