...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Feb 14. 08:40
...
(1, '3D Printed House', 5503, 'A 2-bedroom 3D printed house', 8, 9, 1, 'images/3D_Printed_House.jpg'),
(2, 'Animal Wall Lamps', 6870, 'Decorative Animal Inspired Wall Lamps', 80, 8, 5, 'images/3D_Printed_Animal_Lamps.jpg'),
(3, '3D_Printed_Chair', 8050, 'A fully 3D printed chair with ergonomic and natural looking design.', 200, 10, 16, 'images/3D_Printed_Chair.jpg'),
(4, 'Mini Christmas Tree Decor', 1110, 'Adorable tabletop-sized mini Christmas tree for festive decor', 36, 5, 6, 'images/Mini_Christmass_Tree_Decoration.jpg'),
(5, 'Christmass Tree Decoration', 260, 'Beautiful Christmass Tree Decoration', 75, 5, 14, 'images/3D_Printed_Christmass_Decoration.jpg'),
(6, 'Designer Office Chair', 1415, 'Ergonomically designed office chair for a stylish and comfortable workspace', 190, 10, 18, 'path/to/image18.jpg'),
(7, 'Concrete Bench and Table', 22000, 'An affordable City Bench and table combo made with 3D printed concrete.', 230, 10, 20, 'images/City_Bench.jpg'),
(8, 'Printed Vase Containers', 2000, '3D Printed Vase Containers for all of your needs.', 120, 1, 4, 'images/3D_Printed_Containers.jpg'),
(9, 'Portable Electric Blender', 6755, 'Compact and portable electric blender for on-the-go smoothies', 95, 9, 11, 'path/to/image11.jpg'),
(10, 'Ultra HD Smart TV', 13670, 'Ultra HD smart TV with advanced features for an immersive viewing experience', 220, 9, 15, 'path/to/image15.jpg'),
(11, 'Professional DSLR Camera', 1080, 'High-performance professional DSLR camera for photography enthusiasts', 180, 9, 10, 'path/to/image10.jpg'),
(12, 'Modern Coffee Table', 7523, 'Elegant 3D printed coffee table with metal legs', 12, 10, 2, 'path/to/image2.jpg'),
(13, 'Premium Wireless Speaker', 1075, 'Premium wireless speaker for high-quality audio streaming', 170, 9, 17, 'path/to/image17.jpg'),
(14, 'Smart Home Security Camera', 8572, 'Advanced smart home security camera for monitoring your space', 130, 9, 7, 'path/to/image7.jpg'),
(15, 'Contemporary Dining Chair', 12750, 'Comfortable 3D printed dining chair with sleek design', 20, 10, 3, 'path/to/image3.jpg'),
(16, 'Outdoor Adventure Backpack', 1225, 'Durable outdoor adventure backpack with multiple compartments', 210, 9, 19, 'path/to/image19.jpg'),
(17, 'Home Theater Sound System', 150, 'Immersive home theater sound system for a cinematic experience', 250, 9, 12, 'path/to/image12.jpg'),
(18, 'Compact Air Purifier', 7057, 'Compact air purifier for maintaining clean and fresh indoor air', 110, 9, 9, 'path/to/image9.jpg'),
(19, 'Wireless Noise-Canceling Headphones', 96785, 'Premium wireless headphones with noise-canceling technology', 140, 9, 8, 'path/to/image8.jpg'),
(20, 'Smart Fitness Tracker', 880, 'Intelligent fitness tracker for tracking your health and workouts', 135, 9, 13, 'path/to/image13.jpg');
