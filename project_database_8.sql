...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Jan 15. 12:15
...
--
ALTER TABLE `termekek`
  ADD CONSTRAINT `termekek_ibfk_1` FOREIGN KEY (`SzinId`) REFERENCES `szinkapcsolo` (`TermekSzinKapcsoloId`) ON DELETE CASCADE ON UPDATE CASCADE,
